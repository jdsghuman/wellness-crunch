  ...
  return (
    <Container>
      <div className={`flex flex-row justify-center max-md:flex-col`}>
        <div className="flex-grow bg-[#133C55] md:max-w-[250px] max-md:w-full max-md:h-[120px] flex items-start max-md:items-center justify-center text-white">
        ...
        <div className="w-full max-w-[900px] px-12 max-sm:px-4 py-8">
          ...
          <p className={`my-2 ${poppins300.className} text-base`}>
            ...
            email at{" "}
            <span className={`my-2 ${poppins600.className}`}>
